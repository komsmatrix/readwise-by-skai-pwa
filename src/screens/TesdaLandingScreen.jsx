    ...
    <div style={s.root}>
      ...
      <section style={s.hero}>
        ...
        <div style={s.examBadges}>
          {[
            'Cookery NC II','Housekeeping NC II','Beauty Care NC II',
            'Welding NC II','Food & Beverage NC II','Masonry NC II',
          ].map((e) => (
      ...
      <section id="available" style={{ ...s.section, background:'#141414' }}>
        <div style={s.container}>
          ...
          <h2 style={s.sectionTitle}>{tesdaQuals.length || '6'} Qualifications Ready Today</h2>
